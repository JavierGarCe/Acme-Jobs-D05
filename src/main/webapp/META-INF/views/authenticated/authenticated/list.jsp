...
<form>
	<acme:message code="authenticated.authenticated.form.select"/>
	<select name="idAuthenticated" id="idAuthenticated">
		...
		<jstl:forEach var= "var" begin="${0}" end = "${model$size-1}">
			...
			<option value="${requestScope[var1]}"><jstl:out value="${requestScope[var2]}"/>
